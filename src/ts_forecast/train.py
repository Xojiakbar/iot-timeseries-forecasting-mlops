        ...
        if va_loss < best_val:
            ...
            torch.save(

                {
                    ...
                    "standardizer_x": None if bundle.standardizer_x is None else {

   		    "mean": bundle.standardizer_x.mean.tolist(),

   		    "std": bundle.standardizer_x.std.tolist(),

		},

		    "standardizer_y": None if bundle.standardizer_y is None else {

		    "mean": bundle.standardizer_y.mean.tolist(),

		    "std": bundle.standardizer_y.std.tolist(),
